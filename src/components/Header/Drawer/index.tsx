...
const Drawer = ({ open, setOpen, classNames, links }: thisProps) => {
    ...
    return ReactDOM.createPortal(
        <div id='drawer'>
            ...
            />
            <div className={`fixed shadow-card w-[300px] p-[16px] max-w-full !z-[1000] !duration-400 ml-[-20px] h-[100vh] top-0 right-0 flex  shadow-lg flex-col gap-[16px] items-center ${open ? 'translate-x-[0] duration-400' : 'translate-x-[300px]'} bg-primary border-1 border-white rounded-l-lg py-6`}>
